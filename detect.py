        ...
        try:
            while cap.isOpened():
                ...
                if args.debug:
                    ...
                    cv2.putText(frame, f"Persons: {detected_persons}", (150, 75), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
                    cv2.putText(frame, f"inference TIme: {(inference_time * 1000):.4f} ms", (30, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
